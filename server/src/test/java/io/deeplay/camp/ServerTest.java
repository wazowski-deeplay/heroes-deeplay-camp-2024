...
class ServerTest {
  ...
  void createGamePartyWithInvalidGameTypeTest() {
    ...
    Assertions.assertEquals(
        ConnectionErrorCode.UNIDENTIFIED_ERROR, ((ErrorResponseDto) errorDto).getErrorCode());
  }
  ...
  void joinNonExistentGamePartyTest() {
    ...
    Assertions.assertInstanceOf(ErrorResponseDto.class, errorDto);
    Assertions.assertEquals(
        ConnectionErrorCode.NON_EXISTENT_CONNECTION, ((ErrorResponseDto) errorDto).getErrorCode());
  }
  ...
  void joinGamePartyTest_IsNotValid() {
    ...
    Assertions.assertInstanceOf(ErrorResponseDto.class, errorDto);
    Assertions.assertEquals(
        ConnectionErrorCode.FULL_PARTY, ((ErrorResponseDto) errorDto).getErrorCode());
  }
