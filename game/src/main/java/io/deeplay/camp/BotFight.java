...
public class BotFight {
  ...
  public BotFight(BotPlayer botFirst, BotPlayer botSecond, int countGame, boolean infoGame) {
    ...
    game = new Game();
    gameAnalysis = new GameAnalysis(countGame);
  ...
  public void playGames() throws GameException {
    for (int gameCount = 0; gameCount < countGame; gameCount++) {
      ...
      gameAnalysis.setCurrentBoard(game.gameState.getCurrentBoard().getUnits());
  ...
  public void calcResult(int countGame) {
    if (botFirst
        ...
        > botSecond
            ...
            .size()) {
      winsFirstPlayer++;
      gameAnalysis.reviewGame(PlayerType.FIRST_PLAYER, game.gameState, countGame);
        ...
        < botSecond
            ...
            .size()) {
      winsSecondPlayer++;
      gameAnalysis.reviewGame(PlayerType.SECOND_PLAYER, game.gameState, countGame);
        ...
        == botSecond
            ...
            .size()) {
      countDraw++;
      gameAnalysis.reviewGame(PlayerType.DRAW, game.gameState, countGame);
    }
  }
